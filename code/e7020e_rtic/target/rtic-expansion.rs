#[doc = r" The RTIC application module"] pub mod app
{
    ...
    use embedded_hal :: spi :: MODE_3 ; use rtt_target ::
    { rprintln, rtt_init_print } ; use stm32f4xx_hal ::
    {
        gpio :: { Alternate, Output, Pin, PushPull, Speed }, prelude :: *, i2c
        :: { I2c, DutyCycle, Mode }, timer :: Delay,
    } ; use dwt_systick_monotonic :: * ; use stm32f4xx_hal :: gpio :: * ; use
    stm32f4 :: stm32f401 :: * ; #[doc = r" User code from within the module"]
    const FREQ_CORE : u32 = 16_000_000 ; type MyMono = DwtSystick < FREQ_CORE
    > ; type SCL = Pin < Alternate < PushPull, 5_u8 >, 'A', 8_u8 > ; type SDA
    = Pin < Alternate < PushPull, 5_u8 >, 'C', 9_u8 > ;
    #[doc = r" User code end"] #[inline(always)] #[allow(non_snake_case)] fn
    init(cx : init :: Context) -> (Shared, Local, init :: Monotonics)
    {
        let peripherals = Peripherals :: take().unwrap() ; hprintln!
        ("init").ok() ; let systick = cx.core.SYST ; let mut dcb = cx.core.DCB
        ; let dwt = cx.core.DWT ; let mono = DwtSystick ::
        new(& mut dcb, dwt, systick, FREQ_CORE) ; let rcc = cx.device.RCC ;
        let clocks = rcc.constrain().cfgr.sysclk(48.MHz()).freeze() ; let
        gpioa = cx.device.GPIOA ; let gpioc = cx.device.GPIOC ; let gpa =
        gpioa.split() ; let gpc = gpioc.split() ; let mut scl : SCL =
        gpa.pa8.into_alternate() ; let mut sda : SDA =
        gpc.pc9.into_alternate() ; let i2c = I2c ::
        new(peripherals.I2C3, (sda, scl), Mode :: Standard
            { frequency : 400.Hz() }, & clocks) ; use stm32f4xx_hal :: gpio ::
    ...
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ; hprintln!
        ("led_on").ok() ; cx.shared.gpioa.bsrr.write(| w | w.br5().set_bit())
        ; led_off :: spawn_after(1.secs()).ok() ;
    } #[allow(non_snake_case)] fn led_off(cx : led_off :: Context)
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ; hprintln!
        ("led_off").ok() ; cx.shared.gpioa.bsrr.write(| w | w.bs5().set_bit())
        ; led_on :: spawn_after(1.secs()).ok() ;
    } struct Shared { gpioa : stm32f4 :: stm32f401 :: GPIOA, } struct Local {}
    ...
    { pub gpioa : & 'a mut stm32f4 :: stm32f401 :: GPIOA, }
    #[doc = r" Execution context"] #[allow(non_snake_case)]
    ...
    #[link_section = ".uninit.rtic74142"] static
    __rtic_internal_shared_resource_gpioa : rtic :: RacyCell < core :: mem ::
    MaybeUninit < stm32f4 :: stm32f401 :: GPIOA >> = rtic :: RacyCell ::
    ...
    #[link_section = ".uninit.rtic74143"] #[allow(non_camel_case_types)]
    ...
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic74144"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    ...
    :: export :: SCFQ < 2 > > = rtic :: RacyCell ::
    new(rtic :: export :: Queue :: new()) ;
    #[link_section = ".uninit.rtic74145"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    __rtic_internal_led_off_MyMono_INSTANTS : rtic :: RacyCell <
    [core :: mem :: MaybeUninit << DwtSystick < FREQ_CORE > as rtic ::
     Monotonic > :: Instant > ; 1] > = rtic :: RacyCell ::
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic74146"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    ...
    } #[doc(hidden)] mod rtic_ext
    {
        ...
        {
            rtic :: export :: assert_send :: < stm32f4 :: stm32f401 :: GPIOA >
            () ; rtic :: export :: assert_monotonic :: < DwtSystick <
