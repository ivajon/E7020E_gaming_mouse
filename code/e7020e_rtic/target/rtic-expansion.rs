#[doc = r" The RTIC application module"] pub mod app
{
    ...
    } ; use stm32f4 :: stm32f401 :: { SPI1, TIM5 } ; use app :: mouseReport ::
    MouseState ; #[doc = r" User code from within the module"] type Button =
    ...
    enum API
    {
        ...
        MACRO_CONTOLL = 0x04,
    } const POLL_INTERVAL_MS : u8 = 1 ; #[doc = r" User code end"]
    ...
    -> (Shared, Local, init :: Monotonics)
    {
        ...
        Pmw3389 :: new(spi, cs, delay).unwrap() ; let mut motion =
        ...
        gpioc.pc4.into_pull_down_input().erase() ; pmw3389.store_cpi().ok() ;
    ...
    } #[allow(non_snake_case)] fn idle(mut cx : idle :: Context) ->!
    {
        ...
        {
            let status =
            cx.shared.pmw3389.lock(| pmw3389 | { pmw3389.read_status() }) ;
            match status
            {
                Ok(status) =>
                {
                    if status.dx != 0 || status.dy != 0
                    {
                        cx.shared.mouse.lock(| mouse |
                                             {
                                                 mouse.add_x_movement(status.dx
                                                                      as i8) ;
                                                 mouse.add_y_movement(status.dy
                                                                      as i8) ;
                                             }) ;
                    }
                }, Err(e) => { rprintln! ("{:?}", e) ; }
    ...
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ; if dpi ==
        8224 { return ; }
        cx.shared.pmw3389.lock(| pmw3389 | { pmw3389.set_dpi(dpi) ; }) ;
    } struct Shared { mouse : MouseState, pmw3389 : PMW3389, } struct Local
    {
    ...
    __rtic_internal_idleSharedResources < 'a >
    {
        ...
        pub pmw3389 : shared_resources :: pmw3389_that_needs_to_be_locked < 'a
        >,
    } #[doc = r" Execution context"] #[allow(non_snake_case)]
    ...
    } mod shared_resources
    {
        ...
        pmw3389_that_needs_to_be_locked < 'a > { priority : & 'a Priority, }
        impl < 'a > pmw3389_that_needs_to_be_locked < 'a >
        {
            #[inline(always)] pub unsafe fn new(priority : & 'a Priority) ->
            Self { pmw3389_that_needs_to_be_locked { priority } }
            #[inline(always)] pub unsafe fn priority(& self) -> & Priority
            { self.priority }
        }
    } #[allow(non_snake_case)] #[allow(non_camel_case_types)]
    ...
    } #[allow(non_snake_case)] #[doc = "Software task"] pub mod handle_dpi
    {
        ...
        :: __rtic_internal_handle_dpi_spawn as spawn ;
    ...
    } impl < 'a > __rtic_internal_idleSharedResources < 'a >
    {
        ...
        new(priority : & 'a rtic :: export :: Priority) -> Self
        {
            __rtic_internal_idleSharedResources
            {
                ...
                new(priority), pmw3389 : shared_resources ::
                pmw3389_that_needs_to_be_locked :: new(priority),
            }
        }
    ...
    __rtic_internal_shared_resource_pmw3389 : rtic :: RacyCell < core :: mem
    :: MaybeUninit < PMW3389 >> = rtic :: RacyCell ::
    new(core :: mem :: MaybeUninit :: uninit()) ; impl < 'a > rtic :: Mutex
    for shared_resources :: pmw3389_that_needs_to_be_locked < 'a >
    {
        type T = PMW3389 ; #[inline(always)] fn lock < RTIC_INTERNAL_R >
        (& mut self, f : impl FnOnce(& mut PMW3389) -> RTIC_INTERNAL_R) ->
        RTIC_INTERNAL_R
        {
            #[doc = r" Priority ceiling"] const CEILING : u8 = 1u8 ; unsafe
            {
                rtic :: export ::
                lock(__rtic_internal_shared_resource_pmw3389.get_mut() as *
    ...
    #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] static __rtic_internal_handle_dpi_INPUTS : rtic :: RacyCell
    ...
    __rtic_internal_handle_dpiSharedResources < 'a >
    {
        ...
        new(priority : & 'a rtic :: export :: Priority) -> Self
        {
            ...
            {
                pmw3389 : shared_resources :: pmw3389_that_needs_to_be_locked
                :: new(priority),
            }
        }
    } #[allow(non_snake_case)] #[allow(non_camel_case_types)]
    ...
    } #[doc(hidden)] mod rtic_ext
    {
        use super :: * ; #[no_mangle] unsafe extern "C" fn main() ->!
        {
            ...
            export :: assert_send :: < PMW3389 > () ; rtic :: export ::
            ...
            export :: assert_send :: < [u8 ; 16] > () ; rtic :: export ::
            assert_send :: < u16 > () ; rtic :: export :: interrupt ::
            disable() ;
            (0 ..
             1u8).for_each(| i |
                           (& mut *
            ...
            __rtic_init_resources(||
                                  {
                                      ...
                                      ;
                                      __rtic_internal_shared_resource_pmw3389.get_mut().write(core
                                                                                              ::
                                                                                              mem
                                                                                              ::
                                                                                              MaybeUninit
                                                                                              ::
                                                                                              new(shared_resources.pmw3389))
                                      ;
