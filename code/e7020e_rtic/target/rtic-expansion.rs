#[doc = r" The RTIC application module"] pub mod app
{
    ...
    mouseKeyboardReport :: MouseKeyboardState ; use app :: macroSystem ::
    { MacroConfig, Function } ; #[doc = r" User code from within the module"]
    type Button = ErasedPin < Input < PullUp > > ; const POLL_INTERVAL_MS : u8
    = 1 ; #[doc = r" User code end"] #[inline(always)]
