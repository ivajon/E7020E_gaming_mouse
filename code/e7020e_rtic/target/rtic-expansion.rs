#[doc = r" The RTIC application module"] pub mod app
{
    ...
    init(cx : init :: Context) -> (Shared, Local, init :: Monotonics)
    {
        ...
        ;
        (Shared { mouse }, Local { usb_dev, hid, button }, init ::
         Monotonics())
    ...
    #[doc(hidden)] #[link_section = ".uninit.rtic7276"] static
    ...
    #[doc(hidden)] #[link_section = ".uninit.rtic7277"] static
