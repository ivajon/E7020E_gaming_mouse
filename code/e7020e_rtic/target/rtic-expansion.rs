#[doc = r" The RTIC application module"] pub mod app
{
    ...
    } use super :: led ; use cortex_m_semihosting :: hprintln ; use
    dwt_systick_monotonic :: * ; use stm32f4xx_hal :: gpio :: * ;
    ...
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ; hprintln!
        ("rtic: led_on").ok() ; led :: led_on(cx.shared.led) ; led_off ::
        spawn_after(1.secs()).ok() ;
    } #[allow(non_snake_case)] fn led_off(cx : led_off :: Context)
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ; hprintln!
        ("rtic: led_off").ok() ; led :: led_off(cx.shared.led) ; led_on ::
        spawn_after(1.secs()).ok() ;
    ...
    #[link_section = ".uninit.rtic1347"] static
    ...
    #[link_section = ".uninit.rtic1348"] #[allow(non_camel_case_types)]
    ...
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic1349"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    ...
    :: export :: SCFQ < 2 > > = rtic :: RacyCell ::
    new(rtic :: export :: Queue :: new()) ;
    #[link_section = ".uninit.rtic1350"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    __rtic_internal_led_off_MyMono_INSTANTS : rtic :: RacyCell <
    [core :: mem :: MaybeUninit << DwtSystick < FREQ_CORE > as rtic ::
     Monotonic > :: Instant > ; 1] > = rtic :: RacyCell ::
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic1351"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
