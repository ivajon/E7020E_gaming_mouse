#[doc = r" The RTIC application module"] pub mod app
{
    ...
    } use cortex_m :: { iprint, iprintln } ; use dwt_systick_monotonic :: * ;
    use stm32f4xx_hal :: prelude :: * ;
    #[doc = r" User code from within the module"] const FREQ_CORE : u32 =
    48_000_000 ; type MyMono = DwtSystick < FREQ_CORE > ;
    #[doc = r" User code end"] #[inline(always)] #[allow(non_snake_case)] fn
    init(mut cx : init :: Context) -> (Shared, Local, init :: Monotonics)
    {
        let systick = cx.core.SYST ; let mut dcb = cx.core.DCB ; let dwt =
        cx.core.DWT ; let rcc = cx.device.RCC ;
        rcc.ahb1enr.write(| w | w.gpioaen().enabled().gpioben().enabled()) ;
        let clk = rcc.constrain().cfgr.sysclk(48.Mhz()).freeze() ; let mono =
        DwtSystick :: new(& mut dcb, dwt, systick, clk.sysclk().raw()) ; let
        stim = & mut cx.core.ITM.stim ; iprintln! (& mut stim [0], "init") ;
        let gpioa = cx.device.GPIOA ;
        gpioa.moder.write(| w | w.moder5().output()) ; led_on :: spawn().ok()
        ; log :: spawn().ok() ;
        (Shared { gpioa, itm : cx.core.ITM, }, Local { }, init ::
         Monotonics(mono),)
    } #[allow(non_snake_case)] fn idle(mut cx : idle :: Context) ->!
    {
        ...
        cx.shared.itm.lock(| itm |
                           {
                               let stim = & mut itm.stim ; iprintln!
                               (& mut stim [0], "idle") ;
                           }) ; loop { }
    } #[allow(non_snake_case)] fn log(mut cx : log :: Context)
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ;
        cx.shared.itm.lock(| itm |
                           {
                               let stim = & mut itm.stim ; iprint!
                               (& mut stim [0], ".") ;
                           }) ; log :: spawn_after(1.secs()).ok() ;
    } #[allow(non_snake_case)] fn led_on(cx : led_on :: Context)
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ;
        cx.shared.gpioa.bsrr.write(| w | w.bs5().set_bit()) ; led_off ::
        spawn_after(1.millis()).ok() ;
    } #[allow(non_snake_case)] fn led_off(cx : led_off :: Context)
    {
        use rtic :: Mutex as _ ; use rtic :: mutex_prelude :: * ;
        cx.shared.gpioa.bsrr.write(| w | w.br5().set_bit()) ; led_on ::
        spawn_after(9.millis()).ok() ;
    } struct Shared
    {
        gpioa : stm32f4 :: stm32f411 :: GPIOA, itm : cortex_m :: peripheral ::
        ITM,
    } struct Local { } #[doc = r" Monotonics used by the system"]
    ...
    { pub itm : shared_resources :: itm_that_needs_to_be_locked < 'a >, }
    #[doc = r" Execution context"] #[allow(non_snake_case)]
    ...
    } mod shared_resources
    {
        ...
        #[allow(non_camel_case_types)] pub struct itm_that_needs_to_be_locked
        < 'a > { priority : & 'a Priority, } impl < 'a >
        itm_that_needs_to_be_locked < 'a >
        {
            #[inline(always)] pub unsafe fn new(priority : & 'a Priority) ->
            Self { itm_that_needs_to_be_locked { priority } }
            #[inline(always)] pub unsafe fn priority(& self) -> & Priority
            { self.priority }
        }
    } #[allow(non_snake_case)] #[allow(non_camel_case_types)]
    #[doc = "Shared resources `log` has access to"] pub struct
    __rtic_internal_logSharedResources < 'a >
    { pub itm : shared_resources :: itm_that_needs_to_be_locked < 'a >, }
    #[doc = r" Execution context"] #[allow(non_snake_case)]
    #[allow(non_camel_case_types)] pub struct __rtic_internal_log_Context < 'a
    >
    {
        #[doc = r" Shared Resources this task has access to"] pub shared : log
        :: SharedResources < 'a >,
    } impl < 'a > __rtic_internal_log_Context < 'a >
    {
        #[inline(always)] pub unsafe fn
        new(priority : & 'a rtic :: export :: Priority) -> Self
        {
            __rtic_internal_log_Context
            { shared : log :: SharedResources :: new(priority), }
        }
    } #[doc = r" Spawns the task directly"] pub fn __rtic_internal_log_spawn()
    -> Result < (), () >
    {
        let input = () ; unsafe
        {
            if let Some(index) = rtic :: export :: interrupt ::
            free(| _ | (& mut * __rtic_internal_log_FQ.get_mut()).dequeue())
            {
                (& mut *
                 __rtic_internal_log_INPUTS.get_mut()).get_unchecked_mut(usize
                                                                         ::
                ...
                pend(stm32f4 :: stm32f411 :: interrupt :: EXTI1) ; Ok(())
            } else { Err(input) }
        }
    } #[allow(non_snake_case)] #[allow(non_camel_case_types)] pub struct
    __rtic_internal_log_MyMono_SpawnHandle { #[doc(hidden)] marker : u32, }
    impl core :: fmt :: Debug for __rtic_internal_log_MyMono_SpawnHandle
    {
        fn fmt(& self, f : & mut core :: fmt :: Formatter < '_ >) -> core ::
        fmt :: Result { f.debug_struct("MyMono::SpawnHandle").finish() }
    } impl __rtic_internal_log_MyMono_SpawnHandle
    {
            ...
            free(| _ | unsafe
                 {
                     ...
                     let Some((_task, index)) = tq.cancel_marker(self.marker)
                     {
                         let msg =
                         (& *
                          __rtic_internal_log_INPUTS.get()).get_unchecked(usize
                                                                          ::
                                                                          from(index)).as_ptr().read()
                         ;
                         (& mut *
                          __rtic_internal_log_FQ.get_mut()).split().0.enqueue_unchecked(index)
                         ; Ok(msg)
                     } else { Err(()) }
                 })
        } #[inline] pub fn
    ...
    __rtic_internal_log_MyMono_spawn_after(duration : < MyMono as rtic ::
                                           Monotonic > :: Duration) -> Result
    < log :: MyMono :: SpawnHandle, () >
    {
        let instant = monotonics :: MyMono :: now() ;
        __rtic_internal_log_MyMono_spawn_at(instant + duration)
    } #[doc = r" Spawns the task at a fixed time instant"]
    #[allow(non_snake_case)] pub fn
    __rtic_internal_log_MyMono_spawn_at(instant : < MyMono as rtic ::
    ...
    log :: MyMono :: SpawnHandle, () >
    {
        unsafe
        {
            ...
            free(| _ | (& mut * __rtic_internal_log_FQ.get_mut()).dequeue())
            {
                ...
                ;
                (& mut *
                 __rtic_internal_log_MyMono_INSTANTS.get_mut()).get_unchecked_mut(usize
                                                                                  ::
                ...
                free(| _ |
                     {
                         ...
                         { instant, index, task : SCHED_T :: log, marker, } ;
                         ...
                         ; Ok(log :: MyMono :: SpawnHandle { marker })
                     })
            } else { Err(input) }
        }
    } #[allow(non_snake_case)] #[doc = "Software task"] pub mod log
    {
        #[doc(inline)] pub use super :: __rtic_internal_logSharedResources as
        SharedResources ; pub use super :: __rtic_internal_log_Context as
        Context ; pub use super :: __rtic_internal_log_spawn as spawn ; pub
        use MyMono :: spawn_after ; pub use MyMono :: spawn_at ; pub use
        MyMono :: SpawnHandle ; pub mod MyMono
        {
            pub use super :: super :: __rtic_internal_log_MyMono_spawn_after
            as spawn_after ; pub use super :: super ::
            __rtic_internal_log_MyMono_spawn_at as spawn_at ; pub use super ::
            super :: __rtic_internal_log_MyMono_SpawnHandle as SpawnHandle ;
        }
    } #[allow(non_snake_case)] #[allow(non_camel_case_types)]
    #[doc = "Shared resources `led_on` has access to"] pub struct
    __rtic_internal_led_onSharedResources < 'a >
    { pub gpioa : & 'a mut stm32f4 :: stm32f411 :: GPIOA, }
    #[doc = r" Execution context"] #[allow(non_snake_case)]
    ...
    } #[doc = r" app module"] impl < 'a > __rtic_internal_idleSharedResources
    < 'a >
    {
        #[inline(always)] pub unsafe fn
        new(priority : & 'a rtic :: export :: Priority) -> Self
        {
            ...
            {
                itm : shared_resources :: itm_that_needs_to_be_locked ::
                new(priority),
            }
        }
    } #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] #[link_section = ".uninit.rtic0"] static
    __rtic_internal_shared_resource_gpioa : rtic :: RacyCell < core :: mem ::
    MaybeUninit < stm32f4 :: stm32f411 :: GPIOA >> = rtic :: RacyCell ::
    new(core :: mem :: MaybeUninit :: uninit()) ;
    #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] #[link_section = ".uninit.rtic1"] static
    __rtic_internal_shared_resource_itm : rtic :: RacyCell < core :: mem ::
    MaybeUninit < cortex_m :: peripheral :: ITM >> = rtic :: RacyCell ::
    new(core :: mem :: MaybeUninit :: uninit()) ; impl < 'a > rtic :: Mutex
    for shared_resources :: itm_that_needs_to_be_locked < 'a >
    {
        type T = cortex_m :: peripheral :: ITM ; #[inline(always)] fn lock <
        RTIC_INTERNAL_R >
        (& mut self, f : impl FnOnce(& mut cortex_m :: peripheral :: ITM) ->
         RTIC_INTERNAL_R) -> RTIC_INTERNAL_R
        {
            #[doc = r" Priority ceiling"] const CEILING : u8 = 1u8 ; unsafe
            {
                rtic :: export ::
                lock(__rtic_internal_shared_resource_itm.get_mut() as * mut _,
                     self.priority(), CEILING, stm32f4 :: stm32f411 ::
                     NVIC_PRIO_BITS, f,)
            }
        }
    } #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] static __rtic_internal_log_FQ : rtic :: RacyCell < rtic ::
    export :: SCFQ < 2 > > = rtic :: RacyCell ::
    new(rtic :: export :: Queue :: new()) ; #[link_section = ".uninit.rtic2"]
    #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] static __rtic_internal_log_MyMono_INSTANTS : rtic ::
    RacyCell <
    [core :: mem :: MaybeUninit << DwtSystick < FREQ_CORE > as rtic ::
     Monotonic > :: Instant > ; 1] > = rtic :: RacyCell ::
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic3"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    __rtic_internal_log_INPUTS : rtic :: RacyCell <
    ...
    __rtic_internal_logSharedResources < 'a >
    {
        ...
        new(priority : & 'a rtic :: export :: Priority) -> Self
        {
            __rtic_internal_logSharedResources
            {
                itm : shared_resources :: itm_that_needs_to_be_locked ::
                new(priority),
            }
    ...
    :: export :: SCFQ < 2 > > = rtic :: RacyCell ::
    new(rtic :: export :: Queue :: new()) ; #[link_section = ".uninit.rtic4"]
    #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] static __rtic_internal_led_on_MyMono_INSTANTS : rtic ::
    RacyCell <
    [core :: mem :: MaybeUninit << DwtSystick < FREQ_CORE > as rtic ::
     Monotonic > :: Instant > ; 1] > = rtic :: RacyCell ::
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic5"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    ...
    __rtic_internal_led_onSharedResources < 'a >
    {
        ...
        new(priority : & 'a rtic :: export :: Priority) -> Self
        {
            __rtic_internal_led_onSharedResources
            {
                gpioa : & mut *
                (& mut *
                 __rtic_internal_shared_resource_gpioa.get_mut()).as_mut_ptr(),
            }
        }
    } #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] static __rtic_internal_led_off_FQ : rtic :: RacyCell < rtic
    :: export :: SCFQ < 2 > > = rtic :: RacyCell ::
    new(rtic :: export :: Queue :: new()) ; #[link_section = ".uninit.rtic6"]
    #[allow(non_camel_case_types)] #[allow(non_upper_case_globals)]
    #[doc(hidden)] static __rtic_internal_led_off_MyMono_INSTANTS : rtic ::
    RacyCell <
    [core :: mem :: MaybeUninit << DwtSystick < FREQ_CORE > as rtic ::
     Monotonic > :: Instant > ; 1] > = rtic :: RacyCell ::
    new([core :: mem :: MaybeUninit :: uninit(),]) ;
    #[link_section = ".uninit.rtic7"] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] #[doc(hidden)] static
    ...
    #[derive(Clone, Copy)] #[doc(hidden)] pub enum P1_T { log, }
                ...
                (& mut * __rtic_internal_P1_RQ.get_mut()).split().1.dequeue()
                {
                    match task
                    {
                        P1_T :: log =>
                        {
                            ...
                            new(PRIORITY) ;
                            log(log :: Context :: new(priority))
                        }
                    }
                }
            }) ;
    } #[allow(non_snake_case)] #[allow(non_camel_case_types)]
    #[derive(Clone, Copy)] #[doc(hidden)] pub enum P2_T { led_off, led_on, }
    #[doc(hidden)] #[allow(non_camel_case_types)]
    #[allow(non_upper_case_globals)] static __rtic_internal_P2_RQ : rtic ::
    RacyCell < rtic :: export :: SCRQ < P2_T, 3 > > = rtic :: RacyCell ::
    new(rtic :: export :: Queue :: new()) ; #[allow(non_snake_case)]
             ...
             } else { core :: hint :: unreachable_unchecked() })
        {
            match task
            {
                ...
                } SCHED_T :: led_on =>
                {
                    ...
                    free(| _ |
                         (& mut *
                          __rtic_internal_P2_RQ.get_mut()).split().0.enqueue_unchecked((P2_T
                                                                                        ::
                                                                                        led_on,
                                                                                        index)))
                    ; rtic ::
    ...
    } #[doc(hidden)] mod rtic_ext
    {
        ...
        {
            rtic :: export :: assert_send :: < stm32f4 :: stm32f411 :: GPIOA >
            () ; rtic :: export :: assert_send :: < cortex_m :: peripheral ::
            ITM > () ; rtic :: export :: assert_monotonic :: < DwtSystick <
            FREQ_CORE > > () ; rtic :: export :: interrupt :: disable() ;
            (0 ..
             1u8).for_each(| i |
                           (& mut *
                            __rtic_internal_log_FQ.get_mut()).enqueue_unchecked(i))
            ;
            (0 ..
             1u8).for_each(| i |
                           (& mut *
            ...
            __rtic_init_resources(||
                                  {
                                      ...
                                      init(init :: Context ::
                                           new(core.into())) ;
                                      __rtic_internal_shared_resource_gpioa.get_mut().write(core
                                                                                            ::
                                                                                            mem
                                                                                            ::
                                                                                            MaybeUninit
                                                                                            ::
                                                                                            new(shared_resources.gpioa))
                                      ;
                                      __rtic_internal_shared_resource_itm.get_mut().write(core
                                                                                          ::
                                                                                          mem
                                                                                          ::
                                                                                          MaybeUninit
                                                                                          ::
                                                                                          new(shared_resources.itm))
                                      ; monotonics.0.reset() ;
